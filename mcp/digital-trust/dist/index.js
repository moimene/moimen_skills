...
server.registerTool('caseFiles.list', {
    ...
    const result = await client.get('/api/v1/private/case-files', args.query);
...
server.registerTool('caseFiles.create', {
    ...
    const client = makeClient(args);
    const result = await client.post('/api/v1/private/case-files', args.body);
    return { content: [{ type: 'text', text: JSON.stringify(result, null, 2) }] };
});
...
server.registerTool('evidences.create', {
    ...
    const result = await client.post(path, args.body);
    return { content: [{ type: 'text', text: JSON.stringify(result, null, 2) }] };
});
...
server.registerTool('signFile.create', {
    ...
    const client = makeClient(args);
    const result = await client.post('/api/v1/private/sign-file', args.body);
    return { content: [{ type: 'text', text: JSON.stringify(result, null, 2) }] };
});

...
const BaseCollectionViewModel_SearchCaseFileViewModel_ = z
    ...
    .partial()
    .passthrough();
const SearchCaseFileCollectionViewModel = BaseCollectionViewModel_SearchCaseFileViewModel_.and(z
...
const BaseCollectionViewModel_SearchEvidenceGroupViewModel_ = z
    ...
    .partial()
    .passthrough();
const SearchEvidenceGroupCollectionViewModel = BaseCollectionViewModel_SearchEvidenceGroupViewModel_.and(z
...
const BaseCollectionViewModel_SearchEvidenceViewModel_ = z
    ...
    .partial()
    .passthrough();
const SearchEvidenceCollectionViewModel = BaseCollectionViewModel_SearchEvidenceViewModel_.and(z
